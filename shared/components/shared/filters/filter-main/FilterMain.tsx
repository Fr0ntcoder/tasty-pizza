...
import { FilterGroupCheckbox } from '@/shared/components/shared/filters'
import Title from '@/shared/components/shared/title'

import { Input } from '@/shared/components/ui/fields'
...
export const FilterMain = ({ className }: TFilterMain) => {
